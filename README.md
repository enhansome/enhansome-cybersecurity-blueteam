...
* [DShell](https://github.com/USArmyResearchLab/Dshell) ⭐ 5,492 | 🐛 4 | 🌐 Python | 📅 2024-05-07 - Extensible network forensic analysis framework written in Python that enables rapid development of plugins to support the dissection of network packet captures.
* [Password Manager Resources](https://github.com/apple/password-manager-resources) ⭐ 4,795 | 🐛 111 | 🌐 JavaScript | 📅 2026-08-26 - Collaborative, crowd-sourced data and code to make password management better.
* [Clevis](https://github.com/latchset/clevis) ⭐ 1,246 | 🐛 159 | 🌐 Shell | 📅 2026-07-25 - Plugable framework for automated decryption, often used as a Tang client.
...
* [censys-python](https://github.com/censys/censys-python) ⭐ 469 | 🐛 6 | 🌐 Python | 📅 2026-08-21 - Python wrapper to the Censys REST API.
...
* [libcrafter](https://github.com/pellegre/libcrafter) ⭐ 311 | 🐛 5 | 🌐 Rust | 📅 2026-08-23 - High level C++ network packet sniffing and crafting library.
...
* [gVisor](https://github.com/google/gvisor) ⭐ 19,168 | 🐛 828 | 🌐 Go | 📅 2026-08-27 - Application kernel, written in Go, that implements a substantial portion of the Linux system surface to provide an isolation boundary between the application and the host kernel.
* [Prowler](https://github.com/toniblyx/prowler) ⭐ 14,692 | 🐛 279 | 🌐 Python | 📅 2026-08-27 - Tool based on AWS-CLI commands for Amazon Web Services account security assessment and hardening.
* [Scout Suite](https://github.com/nccgroup/ScoutSuite) ⭐ 7,802 | 🐛 296 | 🌐 Python | 📅 2025-09-23 - Open source multi-cloud security-auditing tool, which enables security posture assessment of cloud environments.
...
* [Sealed Secrets](https://github.com/bitnami-labs/sealed-secrets) ⭐ 9,257 | 🐛 71 | 🌐 Go | 📅 2026-08-27 - Kubernetes controller and tool for one-way encrypted Secrets.
...
See also [awesome-devsecops](https://github.com/devsecops/awesome-devsecops) ⭐ 5,460 | 🐛 82 | 📅 2024-05-11.

* [Trivy](https://github.com/aquasecurity/trivy) ⭐ 37,652 | 🐛 261 | 🌐 Go | 📅 2026-08-21 - Simple and comprehensive vulnerability scanner for containers and other artifacts, suitable for use in continuous integration pipelines.
* [SOPS](https://github.com/mozilla/sops) ⭐ 22,936 | 🐛 443 | 🌐 Go | 📅 2026-08-26 - Editor of encrypted files that supports YAML, JSON, ENV, INI and binary formats and encrypts with AWS KMS, GCP KMS, Azure Key Vault, and PGP.
* [Git Secrets](https://github.com/awslabs/git-secrets) ⭐ 13,382 | 🐛 131 | 🌐 Shell | 📅 2025-09-17 - Prevents you from committing passwords and other sensitive information to a git repository.
* [Clair](https://github.com/coreos/clair) ⭐ 11,052 | 🐛 59 | 🌐 Go | 📅 2026-08-25 - Static analysis tool to probe for vulnerabilities introduced via application container (e.g., Docker) images.
...
See also [Awesome-Fuzzing](https://github.com/secfigo/Awesome-Fuzzing) ⭐ 5,905 | 🐛 10 | 📅 2024-04-03.
...
* [Tang](https://github.com/latchset/tang) ⭐ 724 | 🐛 41 | 🌐 C | 📅 2025-03-06 - Server for binding data to network presence; provides data to clients only when they are on a certain (secured) network.
...
See also [awesome-honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,534 | 🐛 23 | 🌐 Python | 📅 2026-06-01.

* [CanaryTokens](https://github.com/thinkst/canarytokens) ⭐ 2,140 | 🐛 5 | 🌐 Python | 📅 2026-08-20 - Self-hostable honeytoken generator and reporting dashboard; demo version available at [CanaryTokens.org](https://canarytokens.org/).
...
* [Endlessh](https://github.com/skeeto/endlessh) ⭐ 8,544 | 🐛 49 | 🌐 C | 📅 2024-06-03 - SSH tarpit that slowly sends an endless banner.
...
* [Bubblewrap](https://github.com/containers/bubblewrap) ⭐ 8,502 | 🐛 191 | 🌐 C | 📅 2026-08-26 - Sandboxing tool for use by unprivileged Linux users capable of restricting access to parts of the operating system or user data.
...
See also [awesome-incident-response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,353 | 🐛 75 | 📅 2026-07-15.

* [LogonTracer](https://github.com/JPCERTCC/LogonTracer) ⭐ 3,222 | 🐛 21 | 🌐 Python | 📅 2026-08-02 - Investigate malicious Windows logon by visualizing and analyzing Windows event log.
...
* [ssh-audit](https://github.com/jtesta/ssh-audit) ⭐ 4,282 | 🐛 39 | 🌐 Python | 📅 2026-07-09 - Simple tool that makes quick recommendations for improving an SSH server's security posture.
...
* [phishing\_catcher](https://github.com/x0rz/phishing_catcher) ⭐ 1,819 | 🐛 44 | 🌐 Python | 📅 2024-08-13 - Configurable script to watch for issuances of suspicious TLS certificates by domain name in the Certificate Transparency Log (CTL) using the [CertStream](https://certstream.calidog.io/) service.
* [CertSpotter](https://github.com/SSLMate/certspotter) ⭐ 1,170 | 🐛 20 | 🌐 Go | 📅 2026-07-29 - Certificate Transparency log monitor from SSLMate that alerts you when a SSL/TLS certificate is issued for one of your domains.
...
* [APTSimulator](https://github.com/NextronSystems/APTSimulator) ⭐ 2,764 | 🐛 4 | 🌐 Batchfile | 📅 2025-09-23 - Toolset to make a system look as if it was the victim of an APT attack.
...
* [Bunkerized-nginx](https://github.com/bunkerity/bunkerized-nginx) ⭐ 10,868 | 🐛 162 | 🌐 Python | 📅 2026-08-27 - Docker image of an NginX configuration and scripts implementing many defensive techniques for Web sites.
...
See also [awesome-pcaptools](https://github.com/caesar0301/awesome-pcaptools) ⭐ 3,415 | 🐛 14 | 📅 2025-09-03.

* [Tsunami](https://github.com/google/tsunami-security-scanner) ⭐ 8,607 | 🐛 13 | 🌐 Java | 📅 2026-06-23 - General purpose network security scanner with an extensible plugin system for detecting high severity vulnerabilities with high confidence.
* [Maltrail](https://github.com/stamparm/maltrail) ⭐ 8,586 | 🐛 23 | 🌐 Python | 📅 2026-08-27 - Malicious network traffic detection system.
* [Arkime](https://github.com/arkime/arkime) ⭐ 7,459 | 🐛 37 | 🌐 C | 📅 2026-08-26 - Augments your current security infrastructure to store and index network traffic in standard PCAP format, providing fast, indexed access.
...
* [VAST](https://github.com/tenzir/vast) ⭐ 757 | 🐛 0 | 🌐 C++ | 📅 2026-08-27 - Free and open-source network telemetry engine for data-driven security investigations.
* [Real Intelligence Threat Analysis (RITA)](https://github.com/activecm/rita) ⭐ 628 | 🐛 25 | 🌐 Go | 📅 2026-06-17 - Open source framework for network traffic analysis that ingests Zeek logs and detects beaconing, DNS tunneling, and more.
...
See also [awesome-sysadmin#monitoring](https://github.com/n1trux/awesome-sysadmin#monitoring) ⭐ 34,997 | 🐛 0 | 📅 2026-08-19.

* [osquery](https://github.com/facebook/osquery) ⭐ 23,524 | 🐛 626 | 🌐 C++ | 📅 2026-08-25 - Operating system instrumentation framework for macOS, Windows, and Linux, exposing the OS as a high-performance relational database that can be queried with a SQL-like syntax.
...
See also [awesome-threat-detection](https://github.com/0x4D31/awesome-threat-detection) ⭐ 4,711 | 🐛 53 | 📅 2026-01-05.
...
See also [awesome-threat-intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,580 | 🐛 116 | 📅 2026-05-31.

* [Sigma](https://github.com/Neo23x0/sigma) ⭐ 10,947 | 🐛 204 | 🌐 Python | 📅 2026-08-18 - Generic signature format for SIEM systems, offering an open signature format that allows you to describe relevant log events in a straightforward manner.
* [YARA](https://github.com/VirusTotal/yara) ⭐ 9,833 | 🐛 170 | 🌐 C | 📅 2026-08-25 - Tool aimed at (but not limited to) helping malware researchers to identify and classify malware samples, described as "the pattern matching swiss army knife" for file patterns and signatures.
...
* [ThreatIngestor](https://github.com/InQuest/ThreatIngestor) ⭐ 924 | 🐛 15 | 🌐 Python | 📅 2026-05-26 - Extendable tool to extract and aggregate IOCs from threat feeds including Twitter, RSS feeds, or other sources.
...
See also [awesome-tor](https://github.com/ajvb/awesome-tor) ⭐ 507 | 🐛 3 | 📅 2023-09-03.
...
* [Headscale](https://github.com/juanfont/headscale) ⭐ 43,219 | 🐛 146 | 🌐 Go | 📅 2026-08-25 - Open source, self-hosted implementation of the Tailscale control server.
* [IPsec VPN Server Auto Setup Scripts](https://github.com/hwdsl2/setup-ipsec-vpn) ⭐ 28,392 | 🐛 2 | 🌐 Shell | 📅 2026-08-27 - Scripts to build your own IPsec VPN server, with IPsec/L2TP, Cisco IPsec and IKEv2.
* [Nebula](https://github.com/slackhq/nebula) ⭐ 17,659 | 🐛 101 | 🌐 Go | 📅 2026-08-26 - Completely open source and self-hosted, scalable overlay networking tool with a focus on performance, simplicity, and security, inspired by tinc.
...
See also [drduh/macOS-Security-and-Privacy-Guide](https://github.com/drduh/macOS-Security-and-Privacy-Guide) ⭐ 22,494 | 🐛 8 | 📅 2026-08-27.
