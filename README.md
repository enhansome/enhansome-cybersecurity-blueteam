...
* [Password Manager Resources](https://github.com/apple/password-manager-resources) ⭐ 4,799 | 🐛 111 | 🌐 JavaScript | 📅 2026-08-28 - Collaborative, crowd-sourced data and code to make password management better.
* [Clevis](https://github.com/latchset/clevis) ⭐ 1,247 | 🐛 159 | 🌐 Shell | 📅 2026-07-25 - Plugable framework for automated decryption, often used as a Tang client.
...
* [gVisor](https://github.com/google/gvisor) ⭐ 19,188 | 🐛 842 | 🌐 Go | 📅 2026-08-29 - Application kernel, written in Go, that implements a substantial portion of the Linux system surface to provide an isolation boundary between the application and the host kernel.
* [Prowler](https://github.com/toniblyx/prowler) ⭐ 14,715 | 🐛 337 | 🌐 Python | 📅 2026-08-28 - Tool based on AWS-CLI commands for Amazon Web Services account security assessment and hardening.
...
* [Sealed Secrets](https://github.com/bitnami-labs/sealed-secrets) ⭐ 9,262 | 🐛 67 | 🌐 Go | 📅 2026-08-27 - Kubernetes controller and tool for one-way encrypted Secrets.
...
See also [awesome-devsecops](https://github.com/devsecops/awesome-devsecops) ⭐ 5,460 | 🐛 83 | 📅 2024-05-11.

* [Trivy](https://github.com/aquasecurity/trivy) ⭐ 37,689 | 🐛 258 | 🌐 Go | 📅 2026-08-28 - Simple and comprehensive vulnerability scanner for containers and other artifacts, suitable for use in continuous integration pipelines.
* [SOPS](https://github.com/mozilla/sops) ⭐ 22,959 | 🐛 444 | 🌐 Go | 📅 2026-08-26 - Editor of encrypted files that supports YAML, JSON, ENV, INI and binary formats and encrypts with AWS KMS, GCP KMS, Azure Key Vault, and PGP.
...
* [Clair](https://github.com/coreos/clair) ⭐ 11,053 | 🐛 59 | 🌐 Go | 📅 2026-08-25 - Static analysis tool to probe for vulnerabilities introduced via application container (e.g., Docker) images.
...
See also [Awesome-Fuzzing](https://github.com/secfigo/Awesome-Fuzzing) ⭐ 5,906 | 🐛 10 | 📅 2024-04-03.
...
* [AllStar](https://github.com/ossf/allstar) ⭐ 1,444 | 🐛 63 | 🌐 Go | 📅 2026-08-24 - GitHub App installed on organizations or repositories to set and enforce security policies.
* [Tang](https://github.com/latchset/tang) ⭐ 725 | 🐛 41 | 🌐 C | 📅 2025-03-06 - Server for binding data to network presence; provides data to clients only when they are on a certain (secured) network.
...
See also [awesome-honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,537 | 🐛 23 | 🌐 Python | 📅 2026-06-01.
...
* [Artillery](https://github.com/BinaryDefense/artillery) ⭐ 1,039 | 🐛 25 | 🌐 Python | 📅 2022-01-06 - Combination honeypot, filesystem monitor, and alerting system designed to protect Linux and Windows operating systems.
* [USB Keystroke Injection Protection](https://github.com/google/ukip) ⭐ 546 | 🐛 4 | 🌐 Python | 📅 2023-07-09 - Daemon for blocking USB keystroke injection devices on Linux systems.
...
* [Bubblewrap](https://github.com/containers/bubblewrap) ⭐ 8,528 | 🐛 193 | 🌐 C | 📅 2026-08-29 - Sandboxing tool for use by unprivileged Linux users capable of restricting access to parts of the operating system or user data.
...
See also [awesome-incident-response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,358 | 🐛 75 | 📅 2026-07-15.
...
* [Fast Incident Response (FIR)](https://github.com/certsocietegenerale/FIR) ⭐ 2,032 | 🐛 15 | 🌐 JavaScript | 📅 2026-08-07 - Cybersecurity incident management platform allowing for easy creation, tracking, and reporting of cybersecurity incidents.
...
* [ssh-audit](https://github.com/jtesta/ssh-audit) ⭐ 4,286 | 🐛 39 | 🌐 Python | 📅 2026-07-09 - Simple tool that makes quick recommendations for improving an SSH server's security posture.
...
* [CertSpotter](https://github.com/SSLMate/certspotter) ⭐ 1,171 | 🐛 20 | 🌐 Go | 📅 2026-07-29 - Certificate Transparency log monitor from SSLMate that alerts you when a SSL/TLS certificate is issued for one of your domains.
...
* [Bunkerized-nginx](https://github.com/bunkerity/bunkerized-nginx) ⭐ 10,880 | 🐛 157 | 🌐 Python | 📅 2026-08-28 - Docker image of an NginX configuration and scripts implementing many defensive techniques for Web sites.
...
See also [awesome-pcaptools](https://github.com/caesar0301/awesome-pcaptools) ⭐ 3,416 | 🐛 14 | 📅 2025-09-03.
...
* [Maltrail](https://github.com/stamparm/maltrail) ⭐ 8,587 | 🐛 25 | 🌐 Python | 📅 2026-08-29 - Malicious network traffic detection system.
* [Arkime](https://github.com/arkime/arkime) ⭐ 7,460 | 🐛 34 | 🌐 C | 📅 2026-08-28 - Augments your current security infrastructure to store and index network traffic in standard PCAP format, providing fast, indexed access.
...
* [VAST](https://github.com/tenzir/vast) ⭐ 757 | 🐛 0 | 🌐 C++ | 📅 2026-08-28 - Free and open-source network telemetry engine for data-driven security investigations.
...
See also [awesome-sysadmin#monitoring](https://github.com/n1trux/awesome-sysadmin#monitoring) ⭐ 35,014 | 🐛 0 | 📅 2026-08-29.

* [osquery](https://github.com/facebook/osquery) ⭐ 23,528 | 🐛 632 | 🌐 C++ | 📅 2026-08-25 - Operating system instrumentation framework for macOS, Windows, and Linux, exposing the OS as a high-performance relational database that can be queried with a SQL-like syntax.
...
See also [awesome-threat-detection](https://github.com/0x4D31/awesome-threat-detection) ⭐ 4,711 | 🐛 54 | 📅 2026-01-05.
...
See also [awesome-threat-intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,582 | 🐛 117 | 📅 2026-05-31.

* [Sigma](https://github.com/Neo23x0/sigma) ⭐ 10,957 | 🐛 209 | 🌐 Python | 📅 2026-08-18 - Generic signature format for SIEM systems, offering an open signature format that allows you to describe relevant log events in a straightforward manner.
* [YARA](https://github.com/VirusTotal/yara) ⭐ 9,838 | 🐛 170 | 🌐 C | 📅 2026-08-25 - Tool aimed at (but not limited to) helping malware researchers to identify and classify malware samples, described as "the pattern matching swiss army knife" for file patterns and signatures.
...
* [ThreatIngestor](https://github.com/InQuest/ThreatIngestor) ⭐ 925 | 🐛 15 | 🌐 Python | 📅 2026-05-26 - Extendable tool to extract and aggregate IOCs from threat feeds including Twitter, RSS feeds, or other sources.
...
* [Headscale](https://github.com/juanfont/headscale) ⭐ 43,297 | 🐛 144 | 🌐 Go | 📅 2026-08-29 - Open source, self-hosted implementation of the Tailscale control server.
* [IPsec VPN Server Auto Setup Scripts](https://github.com/hwdsl2/setup-ipsec-vpn) ⭐ 28,403 | 🐛 1 | 🌐 Shell | 📅 2026-08-29 - Scripts to build your own IPsec VPN server, with IPsec/L2TP, Cisco IPsec and IKEv2.
* [Nebula](https://github.com/slackhq/nebula) ⭐ 17,668 | 🐛 99 | 🌐 Go | 📅 2026-08-28 - Completely open source and self-hosted, scalable overlay networking tool with a focus on performance, simplicity, and security, inspired by tinc.
...
See also [drduh/macOS-Security-and-Privacy-Guide](https://github.com/drduh/macOS-Security-and-Privacy-Guide) ⭐ 22,499 | 🐛 6 | 📅 2026-08-29.
