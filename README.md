...
* [DShell](https://github.com/USArmyResearchLab/Dshell) ⭐ 5,491 | 🐛 4 | 🌐 Python | 📅 2024-05-07 - Extensible network forensic analysis framework written in Python that enables rapid development of plugins to support the dissection of network packet captures.
* [Password Manager Resources](https://github.com/apple/password-manager-resources) ⭐ 4,791 | 🐛 110 | 🌐 JavaScript | 📅 2026-08-22 - Collaborative, crowd-sourced data and code to make password management better.
* [Clevis](https://github.com/latchset/clevis) ⭐ 1,244 | 🐛 159 | 🌐 Shell | 📅 2026-07-25 - Plugable framework for automated decryption, often used as a Tang client.
...
* [gVisor](https://github.com/google/gvisor) ⭐ 19,141 | 🐛 793 | 🌐 Go | 📅 2026-08-22 - Application kernel, written in Go, that implements a substantial portion of the Linux system surface to provide an isolation boundary between the application and the host kernel.
* [Prowler](https://github.com/toniblyx/prowler) ⭐ 14,657 | 🐛 278 | 🌐 Python | 📅 2026-08-22 - Tool based on AWS-CLI commands for Amazon Web Services account security assessment and hardening.
* [Scout Suite](https://github.com/nccgroup/ScoutSuite) ⭐ 7,796 | 🐛 295 | 🌐 Python | 📅 2025-09-23 - Open source multi-cloud security-auditing tool, which enables security posture assessment of cloud environments.
...
See also [awesome-devsecops](https://github.com/devsecops/awesome-devsecops) ⭐ 5,459 | 🐛 80 | 📅 2024-05-11.

* [Trivy](https://github.com/aquasecurity/trivy) ⭐ 37,569 | 🐛 252 | 🌐 Go | 📅 2026-08-21 - Simple and comprehensive vulnerability scanner for containers and other artifacts, suitable for use in continuous integration pipelines.
* [SOPS](https://github.com/mozilla/sops) ⭐ 22,898 | 🐛 443 | 🌐 Go | 📅 2026-08-17 - Editor of encrypted files that supports YAML, JSON, ENV, INI and binary formats and encrypts with AWS KMS, GCP KMS, Azure Key Vault, and PGP.
...
* [helm-secrets](https://github.com/jkroepke/helm-secrets) ⭐ 2,026 | 🐛 1 | 🌐 Shell | 📅 2026-08-21 - Helm plugin that helps manage secrets with Git workflow and stores them anywhere, backed by SOPS.
...
See also [Awesome-Fuzzing](https://github.com/secfigo/Awesome-Fuzzing) ⭐ 5,901 | 🐛 10 | 📅 2024-04-03.
...
* [AllStar](https://github.com/ossf/allstar) ⭐ 1,443 | 🐛 62 | 🌐 Go | 📅 2026-08-19 - GitHub App installed on organizations or repositories to set and enforce security policies.
* [Tang](https://github.com/latchset/tang) ⭐ 722 | 🐛 41 | 🌐 C | 📅 2025-03-06 - Server for binding data to network presence; provides data to clients only when they are on a certain (secured) network.
...
See also [awesome-honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,529 | 🐛 22 | 🌐 Python | 📅 2026-06-01.

* [CanaryTokens](https://github.com/thinkst/canarytokens) ⭐ 2,117 | 🐛 5 | 🌐 Python | 📅 2026-08-20 - Self-hostable honeytoken generator and reporting dashboard; demo version available at [CanaryTokens.org](https://canarytokens.org/).
...
* [Bubblewrap](https://github.com/containers/bubblewrap) ⭐ 8,456 | 🐛 190 | 🌐 C | 📅 2026-06-02 - Sandboxing tool for use by unprivileged Linux users capable of restricting access to parts of the operating system or user data.
...
See also [awesome-incident-response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,347 | 🐛 74 | 📅 2026-07-15.

* [LogonTracer](https://github.com/JPCERTCC/LogonTracer) ⭐ 3,218 | 🐛 21 | 🌐 Python | 📅 2026-08-02 - Investigate malicious Windows logon by visualizing and analyzing Windows event log.
...
* [Fast Incident Response (FIR)](https://github.com/certsocietegenerale/FIR) ⭐ 2,028 | 🐛 15 | 🌐 JavaScript | 📅 2026-08-07 - Cybersecurity incident management platform allowing for easy creation, tracking, and reporting of cybersecurity incidents.
...
* [ssh-audit](https://github.com/jtesta/ssh-audit) ⭐ 4,278 | 🐛 38 | 🌐 Python | 📅 2026-07-09 - Simple tool that makes quick recommendations for improving an SSH server's security posture.
* [Gatekeeper](https://github.com/AltraMayor/gatekeeper) ⭐ 1,631 | 🐛 96 | 🌐 C | 📅 2025-11-05 - First open source Distributed Denial of Service (DDoS) protection system.
...
* [CertSpotter](https://github.com/SSLMate/certspotter) ⭐ 1,168 | 🐛 20 | 🌐 Go | 📅 2026-07-29 - Certificate Transparency log monitor from SSLMate that alerts you when a SSL/TLS certificate is issued for one of your domains.
...
* [Bunkerized-nginx](https://github.com/bunkerity/bunkerized-nginx) ⭐ 10,847 | 🐛 183 | 🌐 Python | 📅 2026-08-21 - Docker image of an NginX configuration and scripts implementing many defensive techniques for Web sites.
...
* [Maltrail](https://github.com/stamparm/maltrail) ⭐ 8,583 | 🐛 22 | 🌐 Python | 📅 2026-08-23 - Malicious network traffic detection system.
* [Arkime](https://github.com/arkime/arkime) ⭐ 7,452 | 🐛 35 | 🌐 C | 📅 2026-08-21 - Augments your current security infrastructure to store and index network traffic in standard PCAP format, providing fast, indexed access.
...
* [VAST](https://github.com/tenzir/vast) ⭐ 756 | 🐛 0 | 🌐 C++ | 📅 2026-08-23 - Free and open-source network telemetry engine for data-driven security investigations.
...
See also [awesome-sysadmin#monitoring](https://github.com/n1trux/awesome-sysadmin#monitoring) ⭐ 34,964 | 🐛 0 | 📅 2026-08-19.
...
* [osquery](https://github.com/facebook/osquery) ⭐ 23,483 | 🐛 623 | 🌐 C++ | 📅 2026-08-19 - Operating system instrumentation framework for macOS, Windows, and Linux, exposing the OS as a high-performance relational database that can be queried with a SQL-like syntax.
...
See also [awesome-threat-detection](https://github.com/0x4D31/awesome-threat-detection) ⭐ 4,709 | 🐛 54 | 📅 2026-01-05.
...
See also [awesome-threat-intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,563 | 🐛 118 | 📅 2026-05-31.

* [Sigma](https://github.com/Neo23x0/sigma) ⭐ 10,929 | 🐛 199 | 🌐 Python | 📅 2026-08-18 - Generic signature format for SIEM systems, offering an open signature format that allows you to describe relevant log events in a straightforward manner.
* [YARA](https://github.com/VirusTotal/yara) ⭐ 9,818 | 🐛 171 | 🌐 C | 📅 2026-08-21 - Tool aimed at (but not limited to) helping malware researchers to identify and classify malware samples, described as "the pattern matching swiss army knife" for file patterns and signatures.
...
* [YARA Rules](https://github.com/Yara-Rules/rules) ⭐ 4,878 | 🐛 28 | 🌐 YARA | 📅 2024-04-17 - Project covering the need for IT security researchers to have a single repository where different Yara signatures are compiled, classified and kept as up to date as possible.
...
* [ESET's Malware IoCs](https://github.com/eset/malware-ioc) ⭐ 1,978 | 🐛 0 | 🌐 YARA | 📅 2026-06-25 - Indicators of Compromises (IOCs) derived from ESET's various investigations.
...
See also [awesome-tor](https://github.com/ajvb/awesome-tor) ⭐ 505 | 🐛 3 | 📅 2023-09-03.
...
* [Headscale](https://github.com/juanfont/headscale) ⭐ 43,101 | 🐛 152 | 🌐 Go | 📅 2026-07-30 - Open source, self-hosted implementation of the Tailscale control server.
* [IPsec VPN Server Auto Setup Scripts](https://github.com/hwdsl2/setup-ipsec-vpn) ⭐ 28,378 | 🐛 1 | 🌐 Shell | 📅 2026-08-22 - Scripts to build your own IPsec VPN server, with IPsec/L2TP, Cisco IPsec and IKEv2.
* [Nebula](https://github.com/slackhq/nebula) ⭐ 17,639 | 🐛 98 | 🌐 Go | 📅 2026-08-21 - Completely open source and self-hosted, scalable overlay networking tool with a focus on performance, simplicity, and security, inspired by tinc.
...
See also [drduh/macOS-Security-and-Privacy-Guide](https://github.com/drduh/macOS-Security-and-Privacy-Guide) ⭐ 22,486 | 🐛 9 | 📅 2026-08-22.
