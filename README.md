...
* [Password Manager Resources](https://github.com/apple/password-manager-resources) ⭐ 4,792 | 🐛 111 | 🌐 JavaScript | 📅 2026-08-25 - Collaborative, crowd-sourced data and code to make password management better.
* [Clevis](https://github.com/latchset/clevis) ⭐ 1,245 | 🐛 159 | 🌐 Shell | 📅 2026-07-25 - Plugable framework for automated decryption, often used as a Tang client.
...
* [censys-python](https://github.com/censys/censys-python) ⭐ 468 | 🐛 6 | 🌐 Python | 📅 2026-08-21 - Python wrapper to the Censys REST API.
...
* [gVisor](https://github.com/google/gvisor) ⭐ 19,153 | 🐛 812 | 🌐 Go | 📅 2026-08-25 - Application kernel, written in Go, that implements a substantial portion of the Linux system surface to provide an isolation boundary between the application and the host kernel.
* [Prowler](https://github.com/toniblyx/prowler) ⭐ 14,673 | 🐛 280 | 🌐 Python | 📅 2026-08-25 - Tool based on AWS-CLI commands for Amazon Web Services account security assessment and hardening.
* [Scout Suite](https://github.com/nccgroup/ScoutSuite) ⭐ 7,799 | 🐛 295 | 🌐 Python | 📅 2025-09-23 - Open source multi-cloud security-auditing tool, which enables security posture assessment of cloud environments.
...
* [Sealed Secrets](https://github.com/bitnami-labs/sealed-secrets) ⭐ 9,256 | 🐛 69 | 🌐 Go | 📅 2026-08-20 - Kubernetes controller and tool for one-way encrypted Secrets.
...
See also [awesome-devsecops](https://github.com/devsecops/awesome-devsecops) ⭐ 5,461 | 🐛 81 | 📅 2024-05-11.

* [Trivy](https://github.com/aquasecurity/trivy) ⭐ 37,604 | 🐛 258 | 🌐 Go | 📅 2026-08-21 - Simple and comprehensive vulnerability scanner for containers and other artifacts, suitable for use in continuous integration pipelines.
* [SOPS](https://github.com/mozilla/sops) ⭐ 22,916 | 🐛 443 | 🌐 Go | 📅 2026-08-24 - Editor of encrypted files that supports YAML, JSON, ENV, INI and binary formats and encrypts with AWS KMS, GCP KMS, Azure Key Vault, and PGP.
...
* [Clair](https://github.com/coreos/clair) ⭐ 11,052 | 🐛 59 | 🌐 Go | 📅 2026-08-24 - Static analysis tool to probe for vulnerabilities introduced via application container (e.g., Docker) images.
...
See also [Awesome-Fuzzing](https://github.com/secfigo/Awesome-Fuzzing) ⭐ 5,903 | 🐛 10 | 📅 2024-04-03.
...
* [AllStar](https://github.com/ossf/allstar) ⭐ 1,443 | 🐛 63 | 🌐 Go | 📅 2026-08-24 - GitHub App installed on organizations or repositories to set and enforce security policies.
...
See also [awesome-honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,533 | 🐛 23 | 🌐 Python | 📅 2026-06-01.

* [CanaryTokens](https://github.com/thinkst/canarytokens) ⭐ 2,138 | 🐛 5 | 🌐 Python | 📅 2026-08-20 - Self-hostable honeytoken generator and reporting dashboard; demo version available at [CanaryTokens.org](https://canarytokens.org/).
...
* [Endlessh](https://github.com/skeeto/endlessh) ⭐ 8,543 | 🐛 49 | 🌐 C | 📅 2024-06-03 - SSH tarpit that slowly sends an endless banner.
...
* [Bubblewrap](https://github.com/containers/bubblewrap) ⭐ 8,469 | 🐛 191 | 🌐 C | 📅 2026-06-02 - Sandboxing tool for use by unprivileged Linux users capable of restricting access to parts of the operating system or user data.
...
See also [awesome-incident-response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,352 | 🐛 74 | 📅 2026-07-15.

* [LogonTracer](https://github.com/JPCERTCC/LogonTracer) ⭐ 3,219 | 🐛 21 | 🌐 Python | 📅 2026-08-02 - Investigate malicious Windows logon by visualizing and analyzing Windows event log.
...
* [phishing\_catcher](https://github.com/x0rz/phishing_catcher) ⭐ 1,820 | 🐛 44 | 🌐 Python | 📅 2024-08-13 - Configurable script to watch for issuances of suspicious TLS certificates by domain name in the Certificate Transparency Log (CTL) using the [CertStream](https://certstream.calidog.io/) service.
...
* [APTSimulator](https://github.com/NextronSystems/APTSimulator) ⭐ 2,762 | 🐛 4 | 🌐 Batchfile | 📅 2025-09-23 - Toolset to make a system look as if it was the victim of an APT attack.
* [Network Flight Simulator (`flightsim`)](https://github.com/alphasoc/flightsim) ⭐ 1,363 | 🐛 25 | 🌐 Go | 📅 2024-04-04 - Utility to generate malicious network traffic and help security teams evaluate security controls and audit their network visibility.
...
* [DumpsterFire](https://github.com/TryCatchHCF/DumpsterFire) ⭐ 1,038 | 🐛 4 | 🌐 Python | 📅 2020-05-27 - Modular, menu-driven, cross-platform tool for building repeatable, time-delayed, distributed security events for Blue Team drills and sensor/alert mapping.
...
* [Bunkerized-nginx](https://github.com/bunkerity/bunkerized-nginx) ⭐ 10,856 | 🐛 160 | 🌐 Python | 📅 2026-08-25 - Docker image of an NginX configuration and scripts implementing many defensive techniques for Web sites.
...
* [Maltrail](https://github.com/stamparm/maltrail) ⭐ 8,588 | 🐛 22 | 🌐 Python | 📅 2026-08-25 - Malicious network traffic detection system.
* [Arkime](https://github.com/arkime/arkime) ⭐ 7,459 | 🐛 37 | 🌐 C | 📅 2026-08-24 - Augments your current security infrastructure to store and index network traffic in standard PCAP format, providing fast, indexed access.
...
* [VAST](https://github.com/tenzir/vast) ⭐ 757 | 🐛 0 | 🌐 C++ | 📅 2026-08-25 - Free and open-source network telemetry engine for data-driven security investigations.
...
See also [awesome-sysadmin#monitoring](https://github.com/n1trux/awesome-sysadmin#monitoring) ⭐ 34,983 | 🐛 0 | 📅 2026-08-19.

* [osquery](https://github.com/facebook/osquery) ⭐ 23,518 | 🐛 627 | 🌐 C++ | 📅 2026-08-19 - Operating system instrumentation framework for macOS, Windows, and Linux, exposing the OS as a high-performance relational database that can be queried with a SQL-like syntax.
...
See also [awesome-threat-intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,575 | 🐛 119 | 📅 2026-05-31.

* [Sigma](https://github.com/Neo23x0/sigma) ⭐ 10,939 | 🐛 199 | 🌐 Python | 📅 2026-08-18 - Generic signature format for SIEM systems, offering an open signature format that allows you to describe relevant log events in a straightforward manner.
* [YARA](https://github.com/VirusTotal/yara) ⭐ 9,826 | 🐛 170 | 🌐 C | 📅 2026-08-25 - Tool aimed at (but not limited to) helping malware researchers to identify and classify malware samples, described as "the pattern matching swiss army knife" for file patterns and signatures.
...
* [Headscale](https://github.com/juanfont/headscale) ⭐ 43,164 | 🐛 154 | 🌐 Go | 📅 2026-08-25 - Open source, self-hosted implementation of the Tailscale control server.
* [IPsec VPN Server Auto Setup Scripts](https://github.com/hwdsl2/setup-ipsec-vpn) ⭐ 28,385 | 🐛 1 | 🌐 Shell | 📅 2026-08-25 - Scripts to build your own IPsec VPN server, with IPsec/L2TP, Cisco IPsec and IKEv2.
* [Nebula](https://github.com/slackhq/nebula) ⭐ 17,652 | 🐛 100 | 🌐 Go | 📅 2026-08-24 - Completely open source and self-hosted, scalable overlay networking tool with a focus on performance, simplicity, and security, inspired by tinc.
...
See also [drduh/macOS-Security-and-Privacy-Guide](https://github.com/drduh/macOS-Security-and-Privacy-Guide) ⭐ 22,485 | 🐛 7 | 📅 2026-08-23.
