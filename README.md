...
* [Password Manager Resources](https://github.com/apple/password-manager-resources) ⭐ 4,832 | 🐛 121 | 🌐 JavaScript | 📅 2026-09-10 - Collaborative, crowd-sourced data and code to make password management better.
...
* [python-stix2](https://github.com/oasis-open/cti-python-stix2) ⭐ 437 | 🐛 67 | 🌐 Python | 📅 2026-02-12 - Python APIs for serializing and de-serializing Structured Threat Information eXpression (STIX) JSON content, plus higher-level APIs for common tasks.
...
* [gVisor](https://github.com/google/gvisor) ⭐ 19,270 | 🐛 888 | 🌐 Go | 📅 2026-09-10 - Application kernel, written in Go, that implements a substantial portion of the Linux system surface to provide an isolation boundary between the application and the host kernel.
* [Prowler](https://github.com/toniblyx/prowler) ⭐ 14,787 | 🐛 368 | 🌐 Python | 📅 2026-09-10 - Tool based on AWS-CLI commands for Amazon Web Services account security assessment and hardening.
* [Scout Suite](https://github.com/nccgroup/ScoutSuite) ⭐ 7,816 | 🐛 298 | 🌐 Python | 📅 2025-09-23 - Open source multi-cloud security-auditing tool, which enables security posture assessment of cloud environments.
...
* [Sealed Secrets](https://github.com/bitnami-labs/sealed-secrets) ⭐ 9,285 | 🐛 68 | 🌐 Go | 📅 2026-09-10 - Kubernetes controller and tool for one-way encrypted Secrets.
...
* [Trivy](https://github.com/aquasecurity/trivy) ⭐ 37,859 | 🐛 271 | 🌐 Go | 📅 2026-09-10 - Simple and comprehensive vulnerability scanner for containers and other artifacts, suitable for use in continuous integration pipelines.
* [SOPS](https://github.com/mozilla/sops) ⭐ 23,080 | 🐛 446 | 🌐 Go | 📅 2026-09-07 - Editor of encrypted files that supports YAML, JSON, ENV, INI and binary formats and encrypts with AWS KMS, GCP KMS, Azure Key Vault, and PGP.
...
* [AllStar](https://github.com/ossf/allstar) ⭐ 1,451 | 🐛 66 | 🌐 Go | 📅 2026-09-10 - GitHub App installed on organizations or repositories to set and enforce security policies.
...
See also [awesome-honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,550 | 🐛 23 | 🌐 Python | 📅 2026-06-01.

* [CanaryTokens](https://github.com/thinkst/canarytokens) ⭐ 2,159 | 🐛 6 | 🌐 Python | 📅 2026-09-10 - Self-hostable honeytoken generator and reporting dashboard; demo version available at [CanaryTokens.org](https://canarytokens.org/).
...
* [Endlessh](https://github.com/skeeto/endlessh) ⭐ 8,550 | 🐛 49 | 🌐 C | 📅 2024-06-03 - SSH tarpit that slowly sends an endless banner.
...
* [Bubblewrap](https://github.com/containers/bubblewrap) ⭐ 8,668 | 🐛 196 | 🌐 C | 📅 2026-09-08 - Sandboxing tool for use by unprivileged Linux users capable of restricting access to parts of the operating system or user data.
...
See also [awesome-incident-response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,379 | 🐛 80 | 📅 2026-07-15.
...
* [King Phisher](https://github.com/securestate/king-phisher) ⭐ 2,586 | 🐛 2 | 🌐 Python | 📅 2026-08-04 - Tool for testing and promoting user awareness by simulating real world phishing attacks.
...
* [APTSimulator](https://github.com/NextronSystems/APTSimulator) ⭐ 2,768 | 🐛 4 | 🌐 Batchfile | 📅 2025-09-23 - Toolset to make a system look as if it was the victim of an APT attack.
...
* [Bunkerized-nginx](https://github.com/bunkerity/bunkerized-nginx) ⭐ 10,931 | 🐛 167 | 🌐 Python | 📅 2026-09-10 - Docker image of an NginX configuration and scripts implementing many defensive techniques for Web sites.
...
* [Maltrail](https://github.com/stamparm/maltrail) ⭐ 8,599 | 🐛 35 | 🌐 Python | 📅 2026-09-09 - Malicious network traffic detection system.
* [Arkime](https://github.com/arkime/arkime) ⭐ 7,461 | 🐛 39 | 🌐 C | 📅 2026-09-10 - Augments your current security infrastructure to store and index network traffic in standard PCAP format, providing fast, indexed access.
...
* [VAST](https://github.com/tenzir/vast) ⭐ 758 | 🐛 0 | 🌐 C++ | 📅 2026-09-10 - Free and open-source network telemetry engine for data-driven security investigations.
...
See also [awesome-sysadmin#monitoring](https://github.com/n1trux/awesome-sysadmin#monitoring) ⭐ 35,112 | 🐛 0 | 📅 2026-09-02.

* [osquery](https://github.com/facebook/osquery) ⭐ 23,560 | 🐛 642 | 🌐 C++ | 📅 2026-09-09 - Operating system instrumentation framework for macOS, Windows, and Linux, exposing the OS as a high-performance relational database that can be queried with a SQL-like syntax.
...
See also [awesome-threat-detection](https://github.com/0x4D31/awesome-threat-detection) ⭐ 4,723 | 🐛 56 | 📅 2026-01-05.
...
See also [awesome-threat-intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,616 | 🐛 138 | 📅 2026-05-31.

* [Sigma](https://github.com/Neo23x0/sigma) ⭐ 11,018 | 🐛 201 | 🌐 Python | 📅 2026-09-07 - Generic signature format for SIEM systems, offering an open signature format that allows you to describe relevant log events in a straightforward manner.
...
* [YARA Rules](https://github.com/Yara-Rules/rules) ⭐ 4,891 | 🐛 27 | 🌐 YARA | 📅 2024-04-17 - Project covering the need for IT security researchers to have a single repository where different Yara signatures are compiled, classified and kept as up to date as possible.
...
* [Headscale](https://github.com/juanfont/headscale) ⭐ 43,725 | 🐛 140 | 🌐 Go | 📅 2026-09-10 - Open source, self-hosted implementation of the Tailscale control server.
* [IPsec VPN Server Auto Setup Scripts](https://github.com/hwdsl2/setup-ipsec-vpn) ⭐ 28,457 | 🐛 1 | 🌐 Shell | 📅 2026-09-08 - Scripts to build your own IPsec VPN server, with IPsec/L2TP, Cisco IPsec and IKEv2.
* [Nebula](https://github.com/slackhq/nebula) ⭐ 18,328 | 🐛 105 | 🌐 Go | 📅 2026-09-09 - Completely open source and self-hosted, scalable overlay networking tool with a focus on performance, simplicity, and security, inspired by tinc.
...
See also [drduh/macOS-Security-and-Privacy-Guide](https://github.com/drduh/macOS-Security-and-Privacy-Guide) ⭐ 22,514 | 🐛 6 | 🌐 Shell | 📅 2026-09-07.
...
See also [awesome-windows#security](https://github.com/Awesome-Windows/Awesome#security) and [awesome-windows-domain-hardening](https://github.com/PaulSec/awesome-windows-domain-hardening) ⭐ 1,799 | 🐛 1 | 📅 2020-01-07.
