...
* [Password Manager Resources](https://github.com/apple/password-manager-resources) ⭐ 4,803 | 🐛 111 | 🌐 JavaScript | 📅 2026-09-02 - Collaborative, crowd-sourced data and code to make password management better.
* [Clevis](https://github.com/latchset/clevis) ⭐ 1,250 | 🐛 159 | 🌐 Shell | 📅 2026-07-25 - Plugable framework for automated decryption, often used as a Tang client.
...
* [python-stix2](https://github.com/oasis-open/cti-python-stix2) ⭐ 435 | 🐛 67 | 🌐 Python | 📅 2026-02-12 - Python APIs for serializing and de-serializing Structured Threat Information eXpression (STIX) JSON content, plus higher-level APIs for common tasks.
* [libcrafter](https://github.com/pellegre/libcrafter) ⭐ 311 | 🐛 4 | 🌐 Rust | 📅 2026-08-29 - High level C++ network packet sniffing and crafting library.
...
* [gVisor](https://github.com/google/gvisor) ⭐ 19,219 | 🐛 865 | 🌐 Go | 📅 2026-09-02 - Application kernel, written in Go, that implements a substantial portion of the Linux system surface to provide an isolation boundary between the application and the host kernel.
* [Prowler](https://github.com/toniblyx/prowler) ⭐ 14,742 | 🐛 369 | 🌐 Python | 📅 2026-09-02 - Tool based on AWS-CLI commands for Amazon Web Services account security assessment and hardening.
* [Scout Suite](https://github.com/nccgroup/ScoutSuite) ⭐ 7,810 | 🐛 296 | 🌐 Python | 📅 2025-09-23 - Open source multi-cloud security-auditing tool, which enables security posture assessment of cloud environments.
* [Principal Mapper (PMapper)](https://github.com/nccgroup/PMapper) ⭐ 1,576 | 🐛 36 | 🌐 Python | 📅 2024-08-02 - Quickly evaluate IAM permissions in AWS via script and library capable of identifying risks in the configuration of AWS Identity and Access Management (IAM) for an AWS account or an AWS organization.
...
* [Sealed Secrets](https://github.com/bitnami-labs/sealed-secrets) ⭐ 9,272 | 🐛 71 | 🌐 Go | 📅 2026-09-01 - Kubernetes controller and tool for one-way encrypted Secrets.
...
* [kube-forensics](https://github.com/keikoproj/kube-forensics) ⭐ 234 | 🐛 24 | 🌐 Go | 📅 2026-07-16 - Allows a cluster administrator to dump the current state of a running pod and all its containers so that security professionals can perform off-line forensic analysis.
...
See also [awesome-devsecops](https://github.com/devsecops/awesome-devsecops) ⭐ 5,463 | 🐛 85 | 📅 2024-05-11.

* [Trivy](https://github.com/aquasecurity/trivy) ⭐ 37,745 | 🐛 268 | 🌐 Go | 📅 2026-09-02 - Simple and comprehensive vulnerability scanner for containers and other artifacts, suitable for use in continuous integration pipelines.
* [SOPS](https://github.com/mozilla/sops) ⭐ 23,002 | 🐛 442 | 🌐 Go | 📅 2026-09-02 - Editor of encrypted files that supports YAML, JSON, ENV, INI and binary formats and encrypts with AWS KMS, GCP KMS, Azure Key Vault, and PGP.
* [Git Secrets](https://github.com/awslabs/git-secrets) ⭐ 13,387 | 🐛 131 | 🌐 Shell | 📅 2025-09-17 - Prevents you from committing passwords and other sensitive information to a git repository.
* [Clair](https://github.com/coreos/clair) ⭐ 11,054 | 🐛 61 | 🌐 Go | 📅 2026-09-02 - Static analysis tool to probe for vulnerabilities introduced via application container (e.g., Docker) images.
...
* [helm-secrets](https://github.com/jkroepke/helm-secrets) ⭐ 2,025 | 🐛 1 | 🌐 Shell | 📅 2026-08-28 - Helm plugin that helps manage secrets with Git workflow and stores them anywhere, backed by SOPS.
* [Bane](https://github.com/genuinetools/bane) ⭐ 1,229 | 🐛 4 | 🌐 Go | 📅 2020-09-17 - Custom and better AppArmor profile generator for Docker containers.
...
See also [Awesome-Fuzzing](https://github.com/secfigo/Awesome-Fuzzing) ⭐ 5,909 | 🐛 11 | 📅 2024-04-03.
...
* [AllStar](https://github.com/ossf/allstar) ⭐ 1,446 | 🐛 63 | 🌐 Go | 📅 2026-08-31 - GitHub App installed on organizations or repositories to set and enforce security policies.
* [Tang](https://github.com/latchset/tang) ⭐ 727 | 🐛 41 | 🌐 C | 📅 2025-03-06 - Server for binding data to network presence; provides data to clients only when they are on a certain (secured) network.
...
See also [awesome-honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,542 | 🐛 24 | 🌐 Python | 📅 2026-06-01.

* [CanaryTokens](https://github.com/thinkst/canarytokens) ⭐ 2,143 | 🐛 5 | 🌐 Python | 📅 2026-09-02 - Self-hostable honeytoken generator and reporting dashboard; demo version available at [CanaryTokens.org](https://canarytokens.org/).
...
* [Endlessh](https://github.com/skeeto/endlessh) ⭐ 8,544 | 🐛 50 | 🌐 C | 📅 2024-06-03 - SSH tarpit that slowly sends an endless banner.
...
* [Artillery](https://github.com/BinaryDefense/artillery) ⭐ 1,040 | 🐛 25 | 🌐 Python | 📅 2022-01-06 - Combination honeypot, filesystem monitor, and alerting system designed to protect Linux and Windows operating systems.
* [USB Keystroke Injection Protection](https://github.com/google/ukip) ⭐ 547 | 🐛 4 | 🌐 Python | 📅 2023-07-09 - Daemon for blocking USB keystroke injection devices on Linux systems.
...
* [Bubblewrap](https://github.com/containers/bubblewrap) ⭐ 8,572 | 🐛 192 | 🌐 C | 📅 2026-09-01 - Sandboxing tool for use by unprivileged Linux users capable of restricting access to parts of the operating system or user data.
...
See also [awesome-incident-response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,369 | 🐛 77 | 📅 2026-07-15.

* [LogonTracer](https://github.com/JPCERTCC/LogonTracer) ⭐ 3,225 | 🐛 21 | 🌐 Python | 📅 2026-08-02 - Investigate malicious Windows logon by visualizing and analyzing Windows event log.
...
* [Fast Incident Response (FIR)](https://github.com/certsocietegenerale/FIR) ⭐ 2,033 | 🐛 13 | 🌐 JavaScript | 📅 2026-08-31 - Cybersecurity incident management platform allowing for easy creation, tracking, and reporting of cybersecurity incidents.
...
* [OSXAuditor](https://github.com/jipegit/OSXAuditor) ⭐ 3,133 | 🐛 8 | 🌐 JavaScript | 📅 2020-07-27 - Free macOS computer forensics tool.
* [OSXCollector](https://github.com/Yelp/osxcollector) ⚠️ Archived - Forensic evidence collection & analysis toolkit for macOS.
* [Untitled Goose Tool](https://github.com/cisagov/untitledgoosetool) ⭐ 963 | 🐛 17 | 🌐 Python | 📅 2026-02-11 - Assists incident response teams by exporting cloud artifacts from Azure/AzureAD/M365 environments in order to run a full investigation despite lacking in logs ingested by a SIEM.
...
* [ssh-audit](https://github.com/jtesta/ssh-audit) ⭐ 4,290 | 🐛 39 | 🌐 Python | 📅 2026-07-09 - Simple tool that makes quick recommendations for improving an SSH server's security posture.
* [Gatekeeper](https://github.com/AltraMayor/gatekeeper) ⭐ 1,634 | 🐛 96 | 🌐 C | 📅 2025-11-05 - First open source Distributed Denial of Service (DDoS) protection system.
...
* [King Phisher](https://github.com/securestate/king-phisher) ⭐ 2,583 | 🐛 2 | 🌐 Python | 📅 2026-08-04 - Tool for testing and promoting user awareness by simulating real world phishing attacks.
* [phishing\_catcher](https://github.com/x0rz/phishing_catcher) ⭐ 1,823 | 🐛 44 | 🌐 Python | 📅 2024-08-13 - Configurable script to watch for issuances of suspicious TLS certificates by domain name in the Certificate Transparency Log (CTL) using the [CertStream](https://certstream.calidog.io/) service.
* [CertSpotter](https://github.com/SSLMate/certspotter) ⭐ 1,173 | 🐛 20 | 🌐 Go | 📅 2026-07-29 - Certificate Transparency log monitor from SSLMate that alerts you when a SSL/TLS certificate is issued for one of your domains.
...
* [mailspoof](https://github.com/serain/mailspoof) ⭐ 137 | 🐛 13 | 🌐 Python | 📅 2022-12-08 - Scans SPF and DMARC records for issues that could allow email spoofing.
...
* [APTSimulator](https://github.com/NextronSystems/APTSimulator) ⭐ 2,765 | 🐛 4 | 🌐 Batchfile | 📅 2025-09-23 - Toolset to make a system look as if it was the victim of an APT attack.
* [Network Flight Simulator (`flightsim`)](https://github.com/alphasoc/flightsim) ⭐ 1,364 | 🐛 24 | 🌐 Go | 📅 2024-04-04 - Utility to generate malicious network traffic and help security teams evaluate security controls and audit their network visibility.
* [RedHunt OS](https://github.com/redhuntlabs/RedHunt-OS) ⭐ 1,318 | 🐛 7 | 📅 2025-01-22 - Ubuntu-based Open Virtual Appliance (`.ova`) preconfigured with several threat emulation tools as well as a defender's toolkit.
...
* [DumpsterFire](https://github.com/TryCatchHCF/DumpsterFire) ⭐ 1,040 | 🐛 4 | 🌐 Python | 📅 2020-05-27 - Modular, menu-driven, cross-platform tool for building repeatable, time-delayed, distributed security events for Blue Team drills and sensor/alert mapping.
...
* [Bunkerized-nginx](https://github.com/bunkerity/bunkerized-nginx) ⭐ 10,894 | 🐛 162 | 🌐 Python | 📅 2026-09-02 - Docker image of an NginX configuration and scripts implementing many defensive techniques for Web sites.
...
See also [awesome-pcaptools](https://github.com/caesar0301/awesome-pcaptools) ⭐ 3,418 | 🐛 14 | 📅 2025-09-03.

* [Tsunami](https://github.com/google/tsunami-security-scanner) ⭐ 8,611 | 🐛 13 | 🌐 Java | 📅 2026-06-23 - General purpose network security scanner with an extensible plugin system for detecting high severity vulnerabilities with high confidence.
* [Maltrail](https://github.com/stamparm/maltrail) ⭐ 8,593 | 🐛 34 | 🌐 Python | 📅 2026-09-02 - Malicious network traffic detection system.
* [Arkime](https://github.com/arkime/arkime) ⭐ 7,461 | 🐛 41 | 🌐 C | 📅 2026-09-02 - Augments your current security infrastructure to store and index network traffic in standard PCAP format, providing fast, indexed access.
...
* [VAST](https://github.com/tenzir/vast) ⭐ 758 | 🐛 0 | 🌐 C++ | 📅 2026-09-02 - Free and open-source network telemetry engine for data-driven security investigations.
* [Real Intelligence Threat Analysis (RITA)](https://github.com/activecm/rita) ⭐ 633 | 🐛 25 | 🌐 Go | 📅 2026-06-17 - Open source framework for network traffic analysis that ingests Zeek logs and detects beaconing, DNS tunneling, and more.
...
See also [awesome-sysadmin#monitoring](https://github.com/n1trux/awesome-sysadmin#monitoring) ⭐ 35,048 | 🐛 0 | 📅 2026-09-02.

* [osquery](https://github.com/facebook/osquery) ⭐ 23,534 | 🐛 633 | 🌐 C++ | 📅 2026-08-25 - Operating system instrumentation framework for macOS, Windows, and Linux, exposing the OS as a high-performance relational database that can be queried with a SQL-like syntax.
...
See also [awesome-threat-detection](https://github.com/0x4D31/awesome-threat-detection) ⭐ 4,717 | 🐛 53 | 📅 2026-01-05.

* [GRR Rapid Response](https://github.com/google/grr) ⭐ 5,089 | 🐛 191 | 🌐 Python | 📅 2026-05-12 - Incident response framework focused on remote live forensics consisting of a Python agent installed on assets and Python-based server infrastructure enabling analysts to quickly triage attacks and perform analysis remotely.
...
* [PSRecon](https://github.com/gfoss/PSRecon) ⭐ 495 | 🐛 4 | 🌐 PowerShell | 📅 2017-07-29 - PSHunt-like tool for analyzing remote Windows systems that also produces a self-contained HTML report of its findings.
...
See also [awesome-threat-intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,589 | 🐛 118 | 📅 2026-05-31.

* [Sigma](https://github.com/Neo23x0/sigma) ⭐ 10,972 | 🐛 207 | 🌐 Python | 📅 2026-09-01 - Generic signature format for SIEM systems, offering an open signature format that allows you to describe relevant log events in a straightforward manner.
* [YARA](https://github.com/VirusTotal/yara) ⭐ 9,846 | 🐛 170 | 🌐 C | 📅 2026-08-25 - Tool aimed at (but not limited to) helping malware researchers to identify and classify malware samples, described as "the pattern matching swiss army knife" for file patterns and signatures.
...
* [ThreatIngestor](https://github.com/InQuest/ThreatIngestor) ⭐ 926 | 🐛 15 | 🌐 Python | 📅 2026-05-26 - Extendable tool to extract and aggregate IOCs from threat feeds including Twitter, RSS feeds, or other sources.
...
* [YARA Rules](https://github.com/Yara-Rules/rules) ⭐ 4,882 | 🐛 27 | 🌐 YARA | 📅 2024-04-17 - Project covering the need for IT security researchers to have a single repository where different Yara signatures are compiled, classified and kept as up to date as possible.
...
See also [awesome-tor](https://github.com/ajvb/awesome-tor) ⭐ 510 | 🐛 3 | 📅 2023-09-03.
...
* [Headscale](https://github.com/juanfont/headscale) ⭐ 43,487 | 🐛 150 | 🌐 Go | 📅 2026-09-02 - Open source, self-hosted implementation of the Tailscale control server.
* [IPsec VPN Server Auto Setup Scripts](https://github.com/hwdsl2/setup-ipsec-vpn) ⭐ 28,413 | 🐛 1 | 🌐 Shell | 📅 2026-08-29 - Scripts to build your own IPsec VPN server, with IPsec/L2TP, Cisco IPsec and IKEv2.
* [Nebula](https://github.com/slackhq/nebula) ⭐ 18,239 | 🐛 103 | 🌐 Go | 📅 2026-09-01 - Completely open source and self-hosted, scalable overlay networking tool with a focus on performance, simplicity, and security, inspired by tinc.
* [Innernet](https://github.com/tonarino/innernet) ⭐ 5,538 | 🐛 83 | 🌐 Rust | 📅 2026-07-28 - Free Software private network system that uses WireGuard under the hood, made to be self-hosted.
...
See also [drduh/macOS-Security-and-Privacy-Guide](https://github.com/drduh/macOS-Security-and-Privacy-Guide) ⭐ 22,505 | 🐛 6 | 📅 2026-08-29.
...
See also [awesome-windows#security](https://github.com/Awesome-Windows/Awesome#security) and [awesome-windows-domain-hardening](https://github.com/PaulSec/awesome-windows-domain-hardening) ⭐ 1,798 | 🐛 1 | 📅 2020-01-07.
...
* [NotRuler](https://github.com/sensepost/notruler) ⭐ 96 | 🐛 3 | 🌐 Go | 📅 2017-10-11 - Detect both client-side rules and VBScript enabled forms used by the [Ruler](https://github.com/sensepost/ruler) ⭐ 2,313 | 🐛 14 | 🌐 Go | 📅 2024-06-10 attack tool when attempting to compromise a Microsoft Exchange server.
...
* [PlumHound](https://github.com/PlumHound/PlumHound) ⭐ 1,313 | 🐛 7 | 🌐 Python | 📅 2025-11-15 - More effectively use BloodHoundAD in continual security life-cycles by utilizing its pathfinding engine to identify Active Directory security vulnerabilities.
