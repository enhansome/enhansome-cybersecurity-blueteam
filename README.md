...
* [Password Manager Resources](https://github.com/apple/password-manager-resources) ⭐ 4,786 | 🐛 131 | 🌐 JavaScript | 📅 2026-08-09 - Collaborative, crowd-sourced data and code to make password management better.
* [Clevis](https://github.com/latchset/clevis) ⭐ 1,241 | 🐛 159 | 🌐 Shell | 📅 2026-07-25 - Plugable framework for automated decryption, often used as a Tang client.
...
* [python-stix2](https://github.com/oasis-open/cti-python-stix2) ⭐ 432 | 🐛 67 | 🌐 Python | 📅 2026-02-12 - Python APIs for serializing and de-serializing Structured Threat Information eXpression (STIX) JSON content, plus higher-level APIs for common tasks.
* [libcrafter](https://github.com/pellegre/libcrafter) ⭐ 312 | 🐛 3 | 🌐 Rust | 📅 2026-08-02 - High level C++ network packet sniffing and crafting library.
...
* [gVisor](https://github.com/google/gvisor) ⭐ 19,069 | 🐛 777 | 🌐 Go | 📅 2026-08-13 - Application kernel, written in Go, that implements a substantial portion of the Linux system surface to provide an isolation boundary between the application and the host kernel.
* [Prowler](https://github.com/toniblyx/prowler) ⭐ 14,577 | 🐛 258 | 🌐 Python | 📅 2026-08-12 - Tool based on AWS-CLI commands for Amazon Web Services account security assessment and hardening.
* [Scout Suite](https://github.com/nccgroup/ScoutSuite) ⭐ 7,788 | 🐛 295 | 🌐 Python | 📅 2025-09-23 - Open source multi-cloud security-auditing tool, which enables security posture assessment of cloud environments.
...
* [Sealed Secrets](https://github.com/bitnami-labs/sealed-secrets) ⭐ 9,238 | 🐛 73 | 🌐 Go | 📅 2026-08-11 - Kubernetes controller and tool for one-way encrypted Secrets.
...
See also [awesome-devsecops](https://github.com/devsecops/awesome-devsecops) ⭐ 5,454 | 🐛 75 | 📅 2024-05-11.

* [Trivy](https://github.com/aquasecurity/trivy) ⭐ 37,379 | 🐛 247 | 🌐 Go | 📅 2026-08-12 - Simple and comprehensive vulnerability scanner for containers and other artifacts, suitable for use in continuous integration pipelines.
* [SOPS](https://github.com/mozilla/sops) ⭐ 22,788 | 🐛 438 | 🌐 Go | 📅 2026-08-10 - Editor of encrypted files that supports YAML, JSON, ENV, INI and binary formats and encrypts with AWS KMS, GCP KMS, Azure Key Vault, and PGP.
* [Git Secrets](https://github.com/awslabs/git-secrets) ⭐ 13,369 | 🐛 131 | 🌐 Shell | 📅 2025-09-17 - Prevents you from committing passwords and other sensitive information to a git repository.
* [Clair](https://github.com/coreos/clair) ⭐ 11,046 | 🐛 58 | 🌐 Go | 📅 2026-08-11 - Static analysis tool to probe for vulnerabilities introduced via application container (e.g., Docker) images.
...
* [helm-secrets](https://github.com/jkroepke/helm-secrets) ⭐ 2,022 | 🐛 3 | 🌐 Shell | 📅 2026-08-07 - Helm plugin that helps manage secrets with Git workflow and stores them anywhere, backed by SOPS.
...
See also [Awesome-Fuzzing](https://github.com/secfigo/Awesome-Fuzzing) ⭐ 5,892 | 🐛 10 | 📅 2024-04-03.
...
* [AllStar](https://github.com/ossf/allstar) ⭐ 1,441 | 🐛 62 | 🌐 Go | 📅 2026-08-10 - GitHub App installed on organizations or repositories to set and enforce security policies.
...
See also [awesome-honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,517 | 🐛 20 | 🌐 Python | 📅 2026-06-01.

* [CanaryTokens](https://github.com/thinkst/canarytokens) ⭐ 2,112 | 🐛 5 | 🌐 Python | 📅 2026-08-12 - Self-hostable honeytoken generator and reporting dashboard; demo version available at [CanaryTokens.org](https://canarytokens.org/).
...
* [Endlessh](https://github.com/skeeto/endlessh) ⭐ 8,534 | 🐛 49 | 🌐 C | 📅 2024-06-03 - SSH tarpit that slowly sends an endless banner.
...
* [Bubblewrap](https://github.com/containers/bubblewrap) ⭐ 8,341 | 🐛 190 | 🌐 C | 📅 2026-06-02 - Sandboxing tool for use by unprivileged Linux users capable of restricting access to parts of the operating system or user data.
...
See also [awesome-incident-response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,317 | 🐛 73 | 📅 2026-07-15.

* [LogonTracer](https://github.com/JPCERTCC/LogonTracer) ⭐ 3,209 | 🐛 21 | 🌐 Python | 📅 2026-08-02 - Investigate malicious Windows logon by visualizing and analyzing Windows event log.
...
* [ssh-audit](https://github.com/jtesta/ssh-audit) ⭐ 4,258 | 🐛 37 | 🌐 Python | 📅 2026-07-09 - Simple tool that makes quick recommendations for improving an SSH server's security posture.
...
* [King Phisher](https://github.com/securestate/king-phisher) ⭐ 2,571 | 🐛 2 | 🌐 Python | 📅 2026-08-04 - Tool for testing and promoting user awareness by simulating real world phishing attacks.
* [phishing\_catcher](https://github.com/x0rz/phishing_catcher) ⭐ 1,814 | 🐛 44 | 🌐 Python | 📅 2024-08-13 - Configurable script to watch for issuances of suspicious TLS certificates by domain name in the Certificate Transparency Log (CTL) using the [CertStream](https://certstream.calidog.io/) service.
* [CertSpotter](https://github.com/SSLMate/certspotter) ⭐ 1,163 | 🐛 20 | 🌐 Go | 📅 2026-07-29 - Certificate Transparency log monitor from SSLMate that alerts you when a SSL/TLS certificate is issued for one of your domains.
...
* [Bunkerized-nginx](https://github.com/bunkerity/bunkerized-nginx) ⭐ 10,803 | 🐛 178 | 🌐 Python | 📅 2026-08-12 - Docker image of an NginX configuration and scripts implementing many defensive techniques for Web sites.
...
See also [awesome-pcaptools](https://github.com/caesar0301/awesome-pcaptools) ⭐ 3,413 | 🐛 15 | 📅 2025-09-03.

* [Tsunami](https://github.com/google/tsunami-security-scanner) ⭐ 8,602 | 🐛 13 | 🌐 Java | 📅 2026-06-23 - General purpose network security scanner with an extensible plugin system for detecting high severity vulnerabilities with high confidence.
* [Maltrail](https://github.com/stamparm/maltrail) ⭐ 8,578 | 🐛 87 | 🌐 Rust | 📅 2026-08-12 - Malicious network traffic detection system.
* [Arkime](https://github.com/arkime/arkime) ⭐ 7,444 | 🐛 37 | 🌐 C | 📅 2026-08-12 - Augments your current security infrastructure to store and index network traffic in standard PCAP format, providing fast, indexed access.
...
* [VAST](https://github.com/tenzir/vast) ⭐ 754 | 🐛 0 | 🌐 C++ | 📅 2026-08-12 - Free and open-source network telemetry engine for data-driven security investigations.
* [Real Intelligence Threat Analysis (RITA)](https://github.com/activecm/rita) ⭐ 621 | 🐛 25 | 🌐 Go | 📅 2026-06-17 - Open source framework for network traffic analysis that ingests Zeek logs and detects beaconing, DNS tunneling, and more.
...
See also [awesome-sysadmin#monitoring](https://github.com/n1trux/awesome-sysadmin#monitoring) ⭐ 34,888 | 🐛 0 | 📅 2026-06-20.
...
* [osquery](https://github.com/facebook/osquery) ⭐ 23,457 | 🐛 625 | 🌐 C++ | 📅 2026-08-13 - Operating system instrumentation framework for macOS, Windows, and Linux, exposing the OS as a high-performance relational database that can be queried with a SQL-like syntax.
...
See also [awesome-threat-detection](https://github.com/0x4D31/awesome-threat-detection) ⭐ 4,699 | 🐛 54 | 📅 2026-01-05.

* [GRR Rapid Response](https://github.com/google/grr) ⭐ 5,086 | 🐛 191 | 🌐 Python | 📅 2026-05-12 - Incident response framework focused on remote live forensics consisting of a Python agent installed on assets and Python-based server infrastructure enabling analysts to quickly triage attacks and perform analysis remotely.
...
See also [awesome-threat-intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,529 | 🐛 114 | 📅 2026-05-31.

* [Sigma](https://github.com/Neo23x0/sigma) ⭐ 10,880 | 🐛 201 | 🌐 Python | 📅 2026-08-12 - Generic signature format for SIEM systems, offering an open signature format that allows you to describe relevant log events in a straightforward manner.
* [YARA](https://github.com/VirusTotal/yara) ⭐ 9,803 | 🐛 176 | 🌐 C | 📅 2026-07-30 - Tool aimed at (but not limited to) helping malware researchers to identify and classify malware samples, described as "the pattern matching swiss army knife" for file patterns and signatures.
...
* [YARA Rules](https://github.com/Yara-Rules/rules) ⭐ 4,870 | 🐛 28 | 🌐 YARA | 📅 2024-04-17 - Project covering the need for IT security researchers to have a single repository where different Yara signatures are compiled, classified and kept as up to date as possible.
...
* [ESET's Malware IoCs](https://github.com/eset/malware-ioc) ⭐ 1,975 | 🐛 0 | 🌐 YARA | 📅 2026-06-25 - Indicators of Compromises (IOCs) derived from ESET's various investigations.
...
See also [awesome-tor](https://github.com/ajvb/awesome-tor) ⭐ 503 | 🐛 3 | 📅 2023-09-03.
...
* [Headscale](https://github.com/juanfont/headscale) ⭐ 42,808 | 🐛 141 | 🌐 Go | 📅 2026-07-30 - Open source, self-hosted implementation of the Tailscale control server.
* [IPsec VPN Server Auto Setup Scripts](https://github.com/hwdsl2/setup-ipsec-vpn) ⭐ 28,334 | 🐛 1 | 🌐 Shell | 📅 2026-08-08 - Scripts to build your own IPsec VPN server, with IPsec/L2TP, Cisco IPsec and IKEv2.
* [Nebula](https://github.com/slackhq/nebula) ⭐ 17,603 | 🐛 101 | 🌐 Go | 📅 2026-08-11 - Completely open source and self-hosted, scalable overlay networking tool with a focus on performance, simplicity, and security, inspired by tinc.
* [Innernet](https://github.com/tonarino/innernet) ⭐ 5,522 | 🐛 83 | 🌐 Rust | 📅 2026-07-28 - Free Software private network system that uses WireGuard under the hood, made to be self-hosted.
...
See also [drduh/macOS-Security-and-Privacy-Guide](https://github.com/drduh/macOS-Security-and-Privacy-Guide) ⭐ 22,493 | 🐛 8 | 📅 2026-08-10.
...
* [Sticky Keys Slayer](https://github.com/linuz/Sticky-Keys-Slayer) ⭐ 350 | 🐛 15 | 🌐 Shell | 📅 2018-03-16 - Establishes a Windows RDP session from a list of hostnames and scans for accessibility tools backdoors, alerting if one is discovered.
