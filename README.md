...
* [Password Manager Resources](https://github.com/apple/password-manager-resources) ⭐ 4,817 | 🐛 117 | 🌐 JavaScript | 📅 2026-09-04 - Collaborative, crowd-sourced data and code to make password management better.
...
* [gVisor](https://github.com/google/gvisor) ⭐ 19,235 | 🐛 873 | 🌐 Go | 📅 2026-09-05 - Application kernel, written in Go, that implements a substantial portion of the Linux system surface to provide an isolation boundary between the application and the host kernel.
* [Prowler](https://github.com/toniblyx/prowler) ⭐ 14,756 | 🐛 376 | 🌐 Python | 📅 2026-09-04 - Tool based on AWS-CLI commands for Amazon Web Services account security assessment and hardening.
...
* [Sealed Secrets](https://github.com/bitnami-labs/sealed-secrets) ⭐ 9,274 | 🐛 68 | 🌐 Go | 📅 2026-09-03 - Kubernetes controller and tool for one-way encrypted Secrets.
...
See also [awesome-devsecops](https://github.com/devsecops/awesome-devsecops) ⭐ 5,466 | 🐛 86 | 📅 2024-05-11.

* [Trivy](https://github.com/aquasecurity/trivy) ⭐ 37,791 | 🐛 265 | 🌐 Go | 📅 2026-09-04 - Simple and comprehensive vulnerability scanner for containers and other artifacts, suitable for use in continuous integration pipelines.
* [SOPS](https://github.com/mozilla/sops) ⭐ 23,029 | 🐛 443 | 🌐 Go | 📅 2026-09-02 - Editor of encrypted files that supports YAML, JSON, ENV, INI and binary formats and encrypts with AWS KMS, GCP KMS, Azure Key Vault, and PGP.
...
See also [awesome-honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,546 | 🐛 22 | 🌐 Python | 📅 2026-06-01.
...
* [Bubblewrap](https://github.com/containers/bubblewrap) ⭐ 8,605 | 🐛 193 | 🌐 C | 📅 2026-09-01 - Sandboxing tool for use by unprivileged Linux users capable of restricting access to parts of the operating system or user data.
...
* [Fast Incident Response (FIR)](https://github.com/certsocietegenerale/FIR) ⭐ 2,033 | 🐛 14 | 🌐 JavaScript | 📅 2026-08-31 - Cybersecurity incident management platform allowing for easy creation, tracking, and reporting of cybersecurity incidents.
...
* [ssh-audit](https://github.com/jtesta/ssh-audit) ⭐ 4,294 | 🐛 39 | 🌐 Python | 📅 2026-07-09 - Simple tool that makes quick recommendations for improving an SSH server's security posture.
...
* [Bunkerized-nginx](https://github.com/bunkerity/bunkerized-nginx) ⭐ 10,903 | 🐛 166 | 🌐 Python | 📅 2026-09-05 - Docker image of an NginX configuration and scripts implementing many defensive techniques for Web sites.
...
* [Maltrail](https://github.com/stamparm/maltrail) ⭐ 8,596 | 🐛 34 | 🌐 Python | 📅 2026-09-05 - Malicious network traffic detection system.
...
* [Real Intelligence Threat Analysis (RITA)](https://github.com/activecm/rita) ⭐ 636 | 🐛 26 | 🌐 Go | 📅 2026-06-17 - Open source framework for network traffic analysis that ingests Zeek logs and detects beaconing, DNS tunneling, and more.
...
See also [awesome-sysadmin#monitoring](https://github.com/n1trux/awesome-sysadmin#monitoring) ⭐ 35,077 | 🐛 0 | 📅 2026-09-02.

* [osquery](https://github.com/facebook/osquery) ⭐ 23,544 | 🐛 637 | 🌐 C++ | 📅 2026-08-25 - Operating system instrumentation framework for macOS, Windows, and Linux, exposing the OS as a high-performance relational database that can be queried with a SQL-like syntax.
...
See also [awesome-threat-intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,604 | 🐛 121 | 📅 2026-05-31.

* [Sigma](https://github.com/Neo23x0/sigma) ⭐ 10,984 | 🐛 196 | 🌐 Python | 📅 2026-09-03 - Generic signature format for SIEM systems, offering an open signature format that allows you to describe relevant log events in a straightforward manner.
* [YARA](https://github.com/VirusTotal/yara) ⭐ 9,848 | 🐛 171 | 🌐 C | 📅 2026-08-25 - Tool aimed at (but not limited to) helping malware researchers to identify and classify malware samples, described as "the pattern matching swiss army knife" for file patterns and signatures.
...
* [Headscale](https://github.com/juanfont/headscale) ⭐ 43,575 | 🐛 144 | 🌐 Go | 📅 2026-09-04 - Open source, self-hosted implementation of the Tailscale control server.
* [IPsec VPN Server Auto Setup Scripts](https://github.com/hwdsl2/setup-ipsec-vpn) ⭐ 28,431 | 🐛 1 | 🌐 Shell | 📅 2026-08-29 - Scripts to build your own IPsec VPN server, with IPsec/L2TP, Cisco IPsec and IKEv2.
* [Nebula](https://github.com/slackhq/nebula) ⭐ 18,290 | 🐛 104 | 🌐 Go | 📅 2026-09-04 - Completely open source and self-hosted, scalable overlay networking tool with a focus on performance, simplicity, and security, inspired by tinc.
...
See also [drduh/macOS-Security-and-Privacy-Guide](https://github.com/drduh/macOS-Security-and-Privacy-Guide) ⭐ 22,508 | 🐛 6 | 📅 2026-08-29.
